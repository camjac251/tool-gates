...
- *(hints)* retire the curl and wget nudges toward xh
...
- *(gates)* cover newly installed modern tools with rules and hints
...
- *(hints)* remove client-only file actions
- *(hooks)* keep shared feedback client-neutral

## [1.33.2](https://github.com/camjac251/tool-gates/compare/v1.33.1...v1.33.2) - 2026-07-30

### Fixed

- *(auto-mode)* hold redirects to system and credential paths
...
- *(hints)* recommend canonical ast-grep executable
- allow full-stream ripgrep counts
...
- *(build)* pass --edition 2024 to rustfmt in build.rs

## [1.19.2](https://github.com/camjac251/tool-gates/compare/v1.19.1...v1.19.2) - 2026-05-08

### Fixed

- *(permissions)* harden accept-edits fallback
...
- *(gates)* nudge curl/xh and firecrawl/ref/exa to gh api for GitHub URLs
