...
<div class="rule-card">
  <header>
    ...
    <span class="count">275 patterns</span>
  </header>
...
<div class="rule-row" data-decision="allow" id="system-meson-compile">
...
<div class="rule-row" data-decision="allow" id="system-ninja-clean">
  <div class="rule-cmd"><span class="prog">ninja</span> clean</div>
  <div><span class="pill allow"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>Allow</span></div>
  <div class="rule-reason">Removes Ninja build artifacts in the current build directory. Everything it deletes is regenerated by rebuilding.</div>
</div>
